    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'Wenn du ein Ziel fixierst, kannst du dieses Ziel nicht löschen.',
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'When you lock a goal, that goal cannot be deleted.',
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'Cuando bloqueas una meta, esa meta no se puede eliminar.',
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'Lorsque vous verrouillez un objectif, cet objectif ne peut pas être supprimé.',
