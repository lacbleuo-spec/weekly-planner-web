...
export function PlannerResponsiveLayout({
  ...
  return (
    <div className='mx-auto max-w-2xl p-5 xl:max-w-none xl:overflow-x-auto xl:p-6'>
      <div className='xl:w-[1728px] xl:origin-top-left xl:scale-85'>
